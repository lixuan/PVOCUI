      ...
      <el-form ref="businessForm" v-loading="loading" :rules="rules" :model="businessForm" class="clearfix">
        <el-row :gutter="8">
          <el-col :xs="24" :sm="24" :lg="10">
            <div class="basic-wrapper" style="padding-bottom: 20px">
...
import {
  ...
  getDelBusContinued,
  getCreateAnnex,
  getAnnexUpload, GetBusInfoForEdit
...
export default {
  ...
  created() {
    this.businessForm.busNO = this.$route.params.no
    this.addDate()
    this.getTableList()
  ...
  methods: {
    ...
    getTableList() {
      ...
      if (this.$route.params.no === '' || this.$route.params.no === null) {
        console.log('当前没有单号')
      } else {
        const data = {
    ...
    getBusInfoForEdit() {
      ...
      GetBusInfoForEdit(data).then(res => {
        if (res.success) {
          ...
          this.businessForm.originCountry = res.result.originCountry,
          this.businessForm.packNO = res.result.packNO,
          this.businessForm.exportCountry = res.result.exportCountry,
          this.businessForm.startPort = res.result.startPort,
          this.businessForm.importCountry = res.result.importCountry,
          this.businessForm.destination = res.result.destination,
          this.businessForm.expectedTime = res.result.expectedTime,
          this.businessForm.modeTransport = res.result.modeTransport,
          this.businessForm.carrierCode = res.result.carrierCode,
          this.businessForm.blawbno = res.result.blawbno,
          this.businessForm.boxMode = res.result.boxMode,
          this.businessForm.containerNO = res.result.containerNO,
          this.businessForm.sealNO = res.result.sealNO,
          this.businessForm.productStatus = res.result.productStatus,
          this.businessForm.finalInvoiceNO = res.result.finalInvoiceNO,
          this.businessForm.invoiceTime = res.result.invoiceTime,
          this.businessForm.fobPrice = res.result.fobPrice,
          this.businessForm.fobCurrency = res.result.fobCurrency,
          this.businessForm.formMNO = res.result.formMNO,
          this.businessForm.tinno = res.result.tinno,
          this.businessForm.bano = res.result.bano,
          this.businessForm.pcRoute = res.result.pcRoute,
          this.businessForm.rcbnNo = res.result.rcbnNo,
          this.businessForm.cnasCode = res.result.cnasCode,
          this.businessForm.letterNO = res.result.letterNO
          this.loading = false
        }
      })
    },
