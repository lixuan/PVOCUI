    ...
    >
      <el-scrollbar class="page-component__scroll">
        <el-form ref="ruleForm" v-loading="loading" size="mini" :model="form" :rules="rules" label-width="120px" style="padding-right:15px">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="是否AGM检验国：" prop="isAGM">
                <el-switch v-model="form.isAGM" active-color="#13ce66" inactive-color="#C0C4CC" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="是否疫区：" prop="isPestArea">
                <el-switch v-model="form.isPestArea" active-color="#13ce66" inactive-color="#C0C4CC" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
        ...
        <country-identifier ref="createCountryComp" />
        <pest-area ref="pestAreaComp" :pshow="form.isPestArea" />
      </el-scrollbar>
      ...
      if (val && val1 && val2) {
        ...
        const data = {
          CountryInfo: {
            ...
            isAGM: this.form.isAGM,
            remarks: this.form.remarks,
            isPestArea: this.form.isPestArea
          },
