      ...
      >
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="120">
          <template slot-scope="{row,$index}">
            <el-button v-if="checkBtnPeimission(markdownPage.markdownPc.permission)||checkBtnPeimission(markdownPage.markdownSc.permission)" type="primary" @click="printing(row)">
              打印
            </el-button>
            <!--            <router-link v-if="row.businessCode === 'PC1 (未注册状态产品证书)' || 'PC2 (注册状态产品证书)' || 'PC3 (许可状态产品证书) '" target="_blank" :to="{path: '/download/'+ row.id}">-->
            <!--              <el-button type="primary">-->
            <!--                打印-->
            <!--              </el-button>-->
            <!--            </router-link>-->
            <!--            <router-link target="_blank" :to="{path: '/printing/'+ row.id}">-->
            <!--              -->
            <!--            </router-link>-->
            <!--            <el-tooltip content="详情" placement="top">-->
            <!--              <el-button circle type="success" icon="el-icon-info" @click="confirmClick(row)"></el-button>-->
            <!--            </el-tooltip>-->
            <!--            <el-tooltip content="编辑" placement="top">-->
            <!--              <el-button circle type="primary" icon="el-icon-edit" @click="handleUpdate(row)"></el-button>-->
            <!--            </el-tooltip>-->
            <!--            <el-tooltip content="删除" placement="top">-->
            <!--              <el-button circle type="danger" icon="el-icon-error" @click="handleDelete(row,$index)"></el-button>-->
            <!--            </el-tooltip>-->
          </template>
        </el-table-column>
      </el-table>
...
import { checkBtnPeimission, markdownPage } from '@/utils/btnRole'
