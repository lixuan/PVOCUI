...
export function getUserList(obj) {
  return fetch({
    url: '/api/services/app/OrganizationUnit/FindAllUsers',
    method: 'post',
    data: obj
  })
}
...
export function getAllUserList(obj) {
  return fetch({
    url: '/api/services/app/User/GetAllUsers',
    method: 'get',
    params: obj
  })
}
...
export function getUserInfoById(obj) {
  return fetch({
    url: '/api/services/app/User/NewGetUserForEdit',
    method: 'post',
    data: obj
  })
}
...
export function createUser(obj) {
  return fetch({
    url: '/api/services/app/User/NewCreateOrUpdateUser',
    method: 'post',
    data: obj
  })
}
...
export function deleteBatchUser(obj) {
  return fetch({
    url: '/api/services/app/User/BatchDelete',
    method: 'post',
    data: obj
  })
}
...
export function getUserComboBox(obj) {
  return fetch({
    url: '/BaseDataService/api/services/app/PublicComboxAppSevrice/GetUserComboBoxForEdit',
    method: 'get',
    params: obj
  })
}
...
export function getOrganizationUnitsAndUsersComboBox(obj) {
  return fetch({
    url: '/BaseDataService/api/services/app/Combox/GetOrganizationUnitsAndUsers',
    method: 'get',
    params: obj
  })
}
...
export function getUserDetailById(obj) {
  return fetch({
    url: '/BaseDataService/api/services/app/User/GetUserDetailById',
    method: 'get',
    params: obj
  })
}
...
export function UpdatePassword(obj) {
  return fetch({
    url: '/api/services/app/Common/UpdatePassword',
    method: 'put',
    data: obj,
    msg: '修改'
  })
