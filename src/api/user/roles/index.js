...
//   return fetch({
//     url: '/api/services/app/Role/GetAllRoles',
//     method: 'get',
//     params:obj
//   });
// }
...
export function updateRoleName(obj) {
  return fetch({
    url: '/api/services/app/Role/UpdateRoleNameAsync',
    method: 'put',
    data: obj
  })
}
...
export function updateRolePermissions(obj) {
  return fetch({
    url: '/api/services/app/Role/UpdateRolePermissionsAsync',
    method: 'put',
    data: obj
  })
}
...
export function getRoleSelectList(obj) {
  return fetch({
    url: '/api/services/app/Common/GetRolesList',
    method: 'get',
    params: obj
  })
}
