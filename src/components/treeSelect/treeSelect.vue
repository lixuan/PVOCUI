<template>
  <div class="chsEqp" @click="treeShow">
    ...
    <el-input v-show="dataChoosedEquipmentNode.length>0?false:true" size="mini" :readonly="true" class="txtPromt" :placeholder="'请选择'+placeholderName" />
    <div v-show="dataChoosedEquipmentNode.length==0?false:true" class="chsEqp-select">
